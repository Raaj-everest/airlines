...
public class FlightsRestController {
    ...
    @PutMapping("/flights")
    public String create(String source, String destination, String departureDate, Integer economyClassCapacity, Integer firstClassCapacity, Integer businessClassCapacity, Integer occupiedEconomicSeats, Integer occupiedFirstClassSeats, Integer occupiedBusinessClassSeats, Integer economyClassBaseFare, Double firstClassBaseFare, Double businessClassBaseFare) {
        return manager.write(source, destination, departureDate, economyClassCapacity, firstClassCapacity, businessClassCapacity, occupiedEconomicSeats, occupiedFirstClassSeats, occupiedBusinessClassSeats, economyClassBaseFare, firstClassBaseFare, businessClassBaseFare);
    }

    @PostMapping("/flights")
    public String update(String number, String source, String destination, String departureDate, Integer economyClassCapacity, Integer firstClassCapacity, Integer businessClassCapacity, Integer occupiedEconomicSeats, Integer occupiedFirstClassSeats, Integer occupiedBusinessClassSeats, Integer economyClassBaseFare, Double firstClassBaseFare, Double businessClassBaseFare) {
        return manager.update(number, source, destination, departureDate, economyClassCapacity, firstClassCapacity, businessClassCapacity, occupiedEconomicSeats, occupiedFirstClassSeats, occupiedBusinessClassSeats, economyClassBaseFare, firstClassBaseFare, businessClassBaseFare);
    }
